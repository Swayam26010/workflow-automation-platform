...
// =====================================================
router.get('/available', authorize(['Employee']), async (req, res) => {
  try {
...
// =====================================================
router.post('/requests/:id/approve', authorize(['Manager', 'HR', 'Finance', 'Admin']), async (req, res) => {
...
// =====================================================
router.post('/requests/:id/reject', authorize(['Manager', 'HR', 'Finance', 'Admin']), async (req, res) => {
  const request_id = req.params.id;
  const user_role = req.user.role;
  const user_id = req.user.id;
...
// =====================================================
router.get('/requests/:id/history', authorize(['Admin', 'Manager', 'HR', 'Finance', 'Employee']), async (req, res) => {
  const request_id = req.params.id;
